...
-- --------------------------------------------------
-- Date Created: 11/10/2013 11:39:31
...
IF OBJECT_ID(N'[dbo].[FK_attend_event]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[user_attending] DROP CONSTRAINT [FK_attend_event];
GO
IF OBJECT_ID(N'[dbo].[FK_attend_user]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[user_attending] DROP CONSTRAINT [FK_attend_user];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_task_creator]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[tasks] DROP CONSTRAINT [FK_task_creator];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_user_notifications_notifications]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[user_notifications] DROP CONSTRAINT [FK_user_notifications_notifications];
GO
IF OBJECT_ID(N'[dbo].[FK_user_notifications_users]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[user_notifications] DROP CONSTRAINT [FK_user_notifications_users];
GO
...
GO
IF OBJECT_ID(N'[dbo].[user_attending]', 'U') IS NOT NULL
    DROP TABLE [dbo].[user_attending];
GO
...
-- Creating table 'user_attending'
CREATE TABLE [dbo].[user_attending] (
    [id] int IDENTITY(1,1) NOT NULL,
    [user_id] int  NOT NULL,
    [event_id] int  NOT NULL
);
...
-- Creating primary key on [id] in table 'user_attending'
ALTER TABLE [dbo].[user_attending]
ADD CONSTRAINT [PK_user_attending]
    PRIMARY KEY CLUSTERED ([id] ASC);
GO
...
-- Creating foreign key on [event_id] in table 'user_attending'
ALTER TABLE [dbo].[user_attending]
ADD CONSTRAINT [FK_attend_event]
    FOREIGN KEY ([event_id])
    REFERENCES [dbo].[events]
        ([id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_attend_event'
CREATE INDEX [IX_FK_attend_event]
ON [dbo].[user_attending]
    ([event_id]);
GO
...
-- Creating foreign key on [creator_user_id] in table 'tasks'
ALTER TABLE [dbo].[tasks]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_task_creator'
CREATE INDEX [IX_FK_task_creator]
ON [dbo].[tasks]
    ([creator_user_id]);
GO
...
-- Creating foreign key on [user_id] in table 'user_attending'
ALTER TABLE [dbo].[user_attending]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_attend_user'
CREATE INDEX [IX_FK_attend_user]
ON [dbo].[user_attending]
    ([user_id]);
GO
...
-- Creating non-clustered index for FOREIGN KEY 'FK_user_notifications_user'
CREATE INDEX [IX_FK_user_notifications_user]
